...
PHP                                  ;C382FC|08      |      ;
SEP #$20                             ;C382FD|E220    |      ;
LDY.W _039E                          ;C382FF|AC9E03  |81039E;
...
.CODE_C3833C:
    LDX.W _039E                          ;C3833C|AE9E03  |81039E;
...
.CODE_C38368:
    LDX.W _039E                          ;C38368|AE9E03  |81039E;
...
STA.W _03BA                          ;C384D6|8DBA03  |8103BA;
...
STA.W _03BA                          ;C384EC|8DBA03  |8103BA;
...
STA.W INIDISP                          ;C3872E|8D0021  |812100;
DEC A                                ;C38731|3A      |      ;
...
STA.W INIDISP                          ;C38747|8D0021  |812100;
PHA                                  ;C3874A|48      |      ;
...
STA.W MOSAIC                          ;C38753|8D0621  |812106;
PLA                                  ;C38756|68      |      ;
DEC A                                ;C38757|3A      |      ;
...
STA.W INIDISP                          ;C3877D|8D0021  |812100;
INC A                                ;C38780|1A      |      ;
...
STA.W INIDISP                          ;C3879A|8D0021  |812100;
PHA                                  ;C3879D|48      |      ;
...
STA.W MOSAIC                          ;C387A6|8D0621  |812106;
PLA                                  ;C387A9|68      |      ;
INC A                                ;C387AA|1A      |      ;
...
TSB.W _03BA                          ;C387BE|0CBA03  |8103BA;
BRA CODE_C387C8                      ;C387C1|8005    |C387C8;

CODE_C387C3:
LDA.B #$0F                           ;C387C3|A90F    |      ;
STA.W INIDISP                          ;C387C5|8D0021  |812100;
...
STX.W x_screen_scroll                          ;C388F2|8E8203  |810382;
STX.W y_screen_scroll                          ;C388F5|8E8403  |810384;
...
STZ.W BG12NBA                          ;C38937|9C0B21  |81210B;
STZ.W _03BA                          ;C3893A|9CBA03  |8103BA;
STZ.W W12SEL                          ;C3893D|9C2321  |812123;
STZ.W $03C5                          ;C38940|9CC503  |8103C5;
STZ.W W34SEL                          ;C38943|9C2421  |812124;
STZ.W WOBJSEL                          ;C38946|9C2521  |812125;
STZ.W MOSAIC                          ;C38949|9C0621  |812106;
...
TSB.W _03BA                          ;C389DB|0CBA03  |8103BA;
...
DEC A                                ;C389F8|3A      |      ;
STA.W WH1                          ;C389F9|8D2721  |812127;
...
incsrc "scripts/a1/old_mans_goat.asm"
...
incsrc "scripts/a1/lisas_dream.asm"
incsrc "scripts/a1/magician.asm"
...
incsrc "scripts/a1/underground_lift.asm"

CODE_C3BE3B:
COP #$A4                             ;C3BE3B|02A4    |      ;
COP #$05                             ;C3BE3D|0205    |      ;
db $04,$04                           ;C3BE3F|        |000004;
LDY.W _039E                          ;C3BE41|AC9E03  |81039E;
...
.hilfe2:
; @DEFAULT_TEXTBOX@
; "Hilfe ! Zu Hilfe !!" -> Default_Text_End
db $10
db 'H','i','l','f','e',' ','!',' ','Z','u',' ','H','i','l','f','e',' ','!','!',$13 : dw Default_Text_End
; @END@


.hilfe1:
; @DEFAULT_TEXTBOX@
; "Hilfe ! Hört mich denn "
; "niemand...HILFE !" -> Default_Text_End
db $10
db 'H','i','l','f','e',' ','!',' ','H','ö','r','t',' ',$D9,'d','e','n','n',' ',$0D
db 'n','i','e','m','a','n','d','.','.','.','H','I','L','F','E',' ','!',$13 : dw Default_Text_End
; @END@

.hilfe0:
; @DEFAULT_TEXTBOX@
; "Zu Hilfe....Bitte !" -> Default_Text_End
db $10
db 'Z','u',' ','H','i','l','f','e','.','.','.','.',$81,'!',$13 : dw Default_Text_End
; @END@
...
ScrollScreenToPlayer:
    ...
    ADC.W #$0001
    CLC
    ADC.W x_screen_scroll
    STA.W LiveEntities.pos_x, X
    STA.W bg2_hofs
    ...
    SBC.W #1
    CLC
    ADC.W y_screen_scroll
    STA.W LiveEntities.pos_y, X
    STA.W bg2_vofs
    RTL
...
; "Welt."
; "Bitte nimm` dies." WFE
; PLAYER_NAME " erhielt EXP!" WFE
; CONT
db $10
db $8F,$B3,$BC,$0D
db 'W','e','l','t','.',$0D
db $81,'n','i','m','m','`',' ','d','i','e','s','.',$11
db $02,$02,' ',$C1,'E','X','P','!',$11
db $0C
; @END@

Text_Return_To_GrassValley:
; @DEFAULT_TEXTBOX@
; "Möchtest Du nach Grass "
; "Valley zurückkehren?" CONT
db $10
db $96,$83,$E3,'G','r','a','s','s',' ',$0D
db 'V','a','l','l','e','y',' ','z','u','r','ü','c','k','k','e','h','r','e','n','?',$0C
; @END@
...
; @NEW_TEXT@
; "Komm wieder, wenn Du "
; "nach Grass Valley zu-"
; "rückkehren willst." -> Default_Text_End
db 'K','o','m','m',' ','w','i','e','d','e','r',',',' ',$F3,$83,$0D
db $E3,'G','r','a','s','s',' ','V','a','l','l','e','y',' ','z','u','-',$0D
db 'r','ü','c','k','k','e','h','r','e','n',' ','w','i','l','l','s','t','.',$13 : dw Default_Text_End
; @END@

incsrc "scripts/a1/outro_lisa_talk.asm"

Default_Text_End:
; @NEW_TEXT@
; WFAK
; LABEL Default_Text_End_Wo_Wfak
; CLEARBOX 6 4
; CONT
db $12
...
LDY.W _039E                          ;C3F896|AC9E03  |81039E;
...
INC A                                ;C3FCFB|1A      |      ;
CLC                                  ;C3FCFC|18      |      ;
ADC.W x_screen_scroll                          ;C3FCFD|6D8203  |810382;
STA.W $0000,X                        ;C3FD00|9D0000  |810000;
STA.W bg2_hofs                          ;C3FD03|8D3E03  |81033E;
LDA.W $0002,X                        ;C3FD06|BD0200  |810002;
INC A                                ;C3FD09|1A      |      ;
CLC                                  ;C3FD0A|18      |      ;
ADC.W y_screen_scroll                          ;C3FD0B|6D8403  |810384;
STA.W $0002,X                        ;C3FD0E|9D0200  |810002;
STA.W bg2_vofs                          ;C3FD11|8D4003  |810340;
PHX                                  ;C3FD14|DA      |      ;
LDA.W _0312                          ;C3FD15|AD1203  |810312;
LSR A                                ;C3FD18|4A      |      ;
LSR A                                ;C3FD19|4A      |      ;
CLC                                  ;C3FD1A|18      |      ;
ADC.W bg2_vofs                          ;C3FD1B|6D4003  |810340;
